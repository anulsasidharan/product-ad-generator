...
import { ChevronLeft, ChevronRight, Copy, FileImage, RefreshCw, Share2, X } from "lucide-react";
...
export function ResultsGallery({ generations, originalProductUrl, onRegenerate }: ResultsGalleryProps) {
  ...
  useEffect(() => {
    ...
    const onKey = (e: KeyboardEvent) => {
      ...
      if (e.key === "ArrowRight") setLightbox((i) => (i === null ? i : Math.min(generations.length - 1, i + 1)));
